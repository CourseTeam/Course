        ...
        var b = function(b, c) {
            var a = f[c],
                ...
                B = function(A, f) {
                    ...
                    for (l = 0; 15 > l; l += 1) c = !A && 1 == (r >> l & 1),
                        6 > l ? d[l][8] = c: 8 > l ? d[l + 1][8] = c: d[y - 15 + l][8] = c;
                    for (l = 0; 15 > l; l += 1) c = !A && 1 == (r >> l & 1),
                        8 > l ? d[8][y - l - 1] = c: 9 > l ? d[8][15 - l - 1 + 1] = c: d[8][15 - l - 1] = c;
                    d[y - 8][8] = !A;
                    if (7 <= b) {
                        r = n.getBCHTypeNumber(b);
                        for (l = 0; 18 > l; l += 1) c = !A && 1 == (r >> l & 1),
                    ...
                    if (null == g) {
                        ...
                        for (var q = 0,
                                 m = c = 0,
                                 B = Array(r.length), k = Array(r.length), t = 0; t < r.length; t += 1) {
                            var w = r[t].dataCount,
                                z = r[t].totalCount - w,
                                c = Math.max(c, w),
                                m = Math.max(m, z);
                            ...
                            for (u = 0; u < k[t].length; u += 1) z = u + w.getLength() - k[t].length,
                                k[t][u] = 0 <= z ? w.get(z) : 0
                        }
            ...
            A.createTableTag = function(d, a) {
                ...
                for (var g = 0; g < A.getModuleCount(); g += 1) {
                    e += "<tr>";
                    for (var b = 0; b < A.getModuleCount(); b += 1) e += '<td style="',
        ...
        var f = {
            ...
            n = function() {
                ...
                m.getLostPoint = function(d) {
                    for (var a = d.getModuleCount(), b = 0, e = 0; e < a; e += 1) for (var c = 0; c < a; c += 1) {
                        for (var m = 0,
                                 f = d.isDark(e, c), h = -1; 1 >= h; h += 1) if (! (0 > e + h || a <= e + h)) for (var k = -1; 1 >= k; k += 1) 0 > c + k || a <= c + k || 0 == h && 0 == k || f != d.isDark(e + h, c + k) || (m += 1);
                        5 < m && (b += 3 + m - 5)
                    }
            ...
            p = function() {
                ...
                a.getRSBlocks = function(a, b) {
                    ...
                    for (var f = e.length / 3,
                             h = [], k = 0; k < f; k += 1) for (var n = e[3 * k + 0], p = e[3 * k + 1], r = e[3 * k + 2], l = 0; l < n; l += 1) h.push(c(p, r));
                    return h
                };
                return a
            } (),
                ...
                var b = [],
                    c = {
                        ...
                        toString: function() {
                            var a;
                            a = "[";
                            for (var c = 0; c < b.length; c += 1) 0 < c && (a += ","),
                                a += b[c];
                            return a + "]"
                        }
                    };
            ...
            w = function() {
                ...
                f.writeByte = function(e) {
                    b = b << 8 | e & 255;
                    c += 8;
                    for (a += 1; 6 <= c;) d += String.fromCharCode(g(b >>> c - 6 & 63)),
                        c -= 6
                };
                f.flush = function() {
                    0 < c && (d += String.fromCharCode(g(b << 6 - c & 63)), c = b = 0);
                    if (0 != a % 3) for (var e = 3 - a % 3,
                                             f = 0; f < e; f += 1) d += "="
                };
                f.toString = function() {
                    return d
            ...
            z = function(b, c) {
                    ...
                    d = function(a) {
                        ...
                        return {
                            write: function(d, f) {
                                ...
                                for (; 8 <= b + f;) a.writeByte(255 & (d << b | c)),
                                    f -= 8 - b,
                                    d >>>= 8 - b,
                                    b = c = 0;
                                c |= d << b;
                ...
                return {
                    ...
                    write: function(g) {
                        ...
                        n.write(4, e);
                        for (var p = 0,
                                 q = String.fromCharCode(a[p]), p = p + 1; p < a.length;) {
                        ...
                        e = k.toByteArray();
                        g.writeByte(2);
                        for (h = 0; 255 < e.length - h;) g.writeByte(255),
                            g.writeBytes(e, h, 255),
                            h += 255;
