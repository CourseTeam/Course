...
// 名、填表人去除,改成工作单位、备注
    ...
    parentHtml += '     <div class="col-xs-12"><p class="text">出生日期</p></div>'
    ...
    parentHtml += '     <div class="col-xs-12"><input class="input" id="p_name" type="text" style="height:40px; width:100%;"></div>'
    parentHtml += ' </div>'
    parentHtml += ' <div  class="row" id="f_tel_text">'
    parentHtml += '     <div class="col-xs-12"><p class="text">邮件</p></div>'
    parentHtml += '     <div class="col-xs-12"><input class="input" id="p_email" type="text" style="height:40px; width:100%;"></div>'
    parentHtml += ' </div>'
    parentHtml += ' <div  class="row" id="f_name_text">'
