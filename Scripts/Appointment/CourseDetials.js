...
function CourseInfo_Details() {
    ...
    if (result.Msg == "OK") {
        ...
        if (CourseDetials.MaxPhaseType > 1) {
            ...
            strHtml_Serve += '      <li style="font-size: 14px;"><strong>镜头可以回放 人生无法重来</strong></li>';
            ...
            strHtml_Serve += '      <p></p>';
            strHtml_Serve += '      <li style="font-size: 14px;"><strong>如何留下这些感动蜕变瞬间？</strong></li>';
            strHtml_Serve += '      <li>“观禾影视文化传媒”为您带来最佳解决方案！帮你把摩英集训营打包带回家！~ 定格蜕变成长瞬间！ 持续放大摩英效应！ 让您的孩子成为“变形计”大片主角！！</li>';
            strHtml_Serve += '      <li>摩英教育全系课程 强势推出 360°蜕变全记录影视定制产品，为您的孩子个性化定制一份专属于他的精彩回忆，一份见证孩子感动、蜕变成长的蓝光高清纪录片，纯净第三方视角真实记录，这将是您给孩子最好的成长礼物！</li>';
            strHtml_Serve += '      <li>每一次的成长，每一次的感动，每一次的蜕变，用镜头记录下来，将瞬间变为永恒。五年、十年后，回头来看，这份青春成长的回忆对孩子的价值是无法用金钱来衡量的!</li>';
            strHtml_Serve += '      <br>';
            strHtml_Serve += '      <img style="width: 100%;" src="../../Images/serviceImg/p_03.png">';
            strHtml_Serve += '      <p></p>';
            strHtml_Serve += '      <li style="font-size: 14px;"><strong>360°蜕变全记录 系列产品</strong></li>';
            strHtml_Serve += '      <li>定制产品以微电影的风格结合记录片的形式，为您完美的保留孩子青春蜕变的恒久记忆，绝对比《爸爸去哪儿》更精彩哦！因为主角就是您的孩子！</li>';
            strHtml_Serve += '      <br>';
            strHtml_Serve += '      <li><strong>摩英统一版回忆视频</strong></li>';
            strHtml_Serve += '      <li>7天全程记录，最后成片时长60分钟，由专业摄像团队+资深剪辑师倾力打造统一版回忆视频，最后刻录成1920x1080FHD蓝光高清D9光盘</li>';
            strHtml_Serve += '      <br>';
            strHtml_Serve += '      <li><strong>VIP摩英大电影（个性定制）</strong></li>';
            ...
            strHtml_Serve += '      <br>';
            strHtml_Serve += '      <li><strong>VIP蜕变水晶相册（个性定制）</strong></li>';
            ...
            strHtml_Serve += '      <p></p>';
            strHtml_Serve += '      <li style="font-size: 14px;"><strong>我们注重的是：</strong></li>';
            strHtml_Serve += '      <li>純净第三方视角真实记录，让您的孩子化身"变形记"主角，拍摄过程中会采取尽可能隐蔽的拍摄方式，以免打扰孩子正常学习生活的情绪状态。</li>';
            strHtml_Serve += '      <li>集训营的八天中我们会根据学员意愿安排单独视频采访及相关主讲老师、助教采访，探访学员内心世界，传达学员真实想法，在学员与家长之间建立真情流露的沟通渠道。</li>';
            strHtml_Serve += '      <li>定制客户的全部视频、照片原始素材均提供为期一年的免费存档服务（自产品订购日起一年内）可供学员及家长随时预约提取。</li>';
            strHtml_Serve += '      <li>因个性化定制占用摄制组团队大量的时间和精力，每期集训营每班仅限3个名额，摄影摄像师会时刻关注您的孩子，记录他们在这八天中的幸福、快乐、感动、蜕变……</li>';
            strHtml_Serve += '      <li>注：名额确定以完款登记时间为准</li>';
            strHtml_Serve += '      <br>';
            strHtml_Serve += '      <img style="width: 100%;" src="../../Images/serviceImg/p_06.png">';
            strHtml_Serve += '      <p></p>';
            strHtml_Serve += '      <li style="font-size: 14px;"><strong>360°蜕变全记录</strong></li>';
