        ...
        if (result.Data) {
            for (var i = 0; i < result.Data.length; i++) {
                ...
                if (row.Status == 4) {
                    ...
                    strHtml += '    <div class="col-xs-3" style="text-align: right;color: #00d6b2" onclick="">修改</div> ';
                    strHtml += '</div>';
                } else {
                    strHtml += '<div class="record">';
                    strHtml += '    <div class="col-xs-4 day">' + date + '</div>';
                    strHtml += '    <div class="col-xs-4 integral">' + row.Integral + '积分' + '</div>';
